...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String[] COLUMN_ODD={"牛奶","纸巾","水盆","芥末","洗发露","锦寒","国拯","梁山伯和祝应台","火锅","四川腊肉","吉利"};//11 default words
    public static final String[] COLUMN_EVEN={"豆浆","手帕","水桶","辣椒","护发素","瑞瑞","华新","罗密欧和朱丽叶","冒菜","河南大锅肉","宝马"};
